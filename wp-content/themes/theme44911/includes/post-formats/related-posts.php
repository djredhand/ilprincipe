					...
					<li class="related-posts_item">
						<?php if(has_post_thumbnail()) { ?>
							<?php
								...
								$image = aq_resize( $img_url, 168, 128, true ); //resize & crop img
							?>
							<figure class="thumbnail featured-thumbnail">
								<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo $image ?>" alt="<?php the_title(); ?>" /><i class="icon-link"></i></a>
							</figure>
						<?php } else { ?>
							<figure class="thumbnail featured-thumbnail">
								<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/empty_thumb.gif" width="168" height="128" alt="<?php the_title(); ?>" /><i class="icon-link"></i></a>
							</figure>
						<?php } ?>
