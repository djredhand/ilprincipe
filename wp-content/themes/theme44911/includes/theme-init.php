...
function my_setup() {
	...
	if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
		...
		set_post_thumbnail_size( 368, 336, true ); // Normal post thumbnails
		add_image_size( 'slider-post-thumbnail', 1162, 592, true ); // Slider Thumbnail
		add_image_size( 'slider-thumb', 88, 51, true ); // Slider Small Thumbnail
	}
